var databases = [
	{
		name: "datasets",
		collections: [
			{"name": "datasets"}, {"name":"contacts"}, {"name":"editions"}, {"name":"instances"}, {"name":"dimension.options"}, {"name":"instances_locks"}, {"name":"versions"}, {"name":"versions_locks"}, {"name": "dataset_events"}
		]
	},
	{
		name: "recipes",
