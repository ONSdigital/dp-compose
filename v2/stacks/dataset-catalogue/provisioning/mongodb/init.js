var databases = [
	{
		name: "datasets",
		collections: [
			{"name": "datasets"}, {"name":"contacts"}, {"name":"editions"}, {"name":"instances"}, {"name":"versions"}, {"name":"dimension.options"}, {"name":"instances_locks"}
		]
	},
	{
		name: "recipes",
	...
	{
		name: "files",
		collections: [{"name":"metadata"},{"name":"collections"},{"name":"bundles"}]
	},
	{
        name: "permissions",
